...
import argparse
import sys
from app.api.run import read_json_file, validate_open_api, parse_open_api, parse_endpoints, get_endpoint_names_from_scenario_result, get_tree_output
from app.api.prompts import pytest_test_scenarios_prompt, pytest_test_write_prompt
from app.api.openrouter import get_openrouter_models, select_model, send_request_to_openrouter, parse_scenarios, select_scenarios_to_run,convert_scenarios_dict_to_list
...
if args.command == 'set-apikey':
    ...
    for chosen_test in chosen_tests:
        ...
        print(send_request_to_openrouter(api_key=api_key_utils.get_api_key(), model_name=chosen, prompt=test_prompt))
